...
uint8_t UARTInterface_GetNextFromBuffer() {
...
//
//
//void PrintCorrectedIMUValues() {
//    printf("Roll: %3.2f     Pitch: %3.2f     Yaw: %3.2f \r\n", IMUInput_GetRoll(), IMUInput_GetPitch(), IMUInput_GetYaw());
//}
//void PrintIMUValues() {
...
//                    break;
//                case 'u':
//                    display_mode = DISPLAY_CORRECTED_IMU;
//                    break;
//            }
//        }
